...
plot_interactiveD3 <- function(model, ..., 
                               selected_variables = NULL, color = NULL,
                               width = NULL, height = NULL){
  
  require(ceterisParibusD3)
  
  ceterisParibusD3(model = model, ..., 
                   selected_variables = selected_variables, color = color,
...
plot_interactiveD3(cp_rf1, cp_rf2, cp_rf3, selected_variables = c('age'), color = "_label_",
